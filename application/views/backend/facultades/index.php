<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Lista de  Programas de Estudio</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12 text-right">
                    <a href="<?php echo base_url(); ?>backend/facultades/add" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Programa de Estudio</a>
                </div>
            </div>
            <!-- /.row -->
             <hr>
