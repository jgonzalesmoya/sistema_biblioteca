...
<body>
    <div class="content">
        <div class="header">
            <h1>Repositorio de Tesis PostGrado UNPRG</h1>
        </div>
        <div class="container content-search">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>Mediante los cuadros de texto puede buscar cualquier tesis</p>
                </div>
            </div>
            <div class="row">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($libros as $libro): ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo base_url(); ?>assets/images/books/<?php echo $libro->imagen_libro; ?>">Ver</a></td>
                                </tr>
                            <?php endforeach;?>
                            <?php endif;?>
                        </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header text-blue">
                    ...
                    <h4 class="modal-title">DESCRIPCION DEL TESIS</h4>
                </div>
